# PowerShell script to run the 02 Model Service
# This script activates the virtual environment and starts the FastAPI model API on port 8001

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Starting 02 Model Service" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan

# Get the script directory and project root
$scriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$projectRoot = Split-Path -Parent $scriptDir
$serviceDir = Join-Path $projectRoot "02_Model_Service"
...
Write-Host "Starting FastAPI Model API on http://127.0.0.1:8001" -ForegroundColor Green
